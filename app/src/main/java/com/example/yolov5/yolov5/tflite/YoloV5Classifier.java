...
package com.example.yolov5.yolov5.tflite;
...
import com.example.yolov5.MainActivity;
import com.example.yolov5.yolov5.env.Utils;
import com.example.yolov5.yolov5.env.Logger;
...
//        float[][][] outbuf = new float[1][output_box][labels.size() + 5];
        ...
        for (int i = 0; i < output_box; ++i){
            ...
            if (confidenceInClass > getObjThresh()) {
                ...
                Log.d("light","detectedClass:"+detectedClass);
            }
